...
import { Save, Upload, FileText, AlertTriangle, ArrowLeft } from 'lucide-react';
...
export default function EditBuildScreen() {
  ...
  const buildId = parseInt(id ?? '0', 10);
  ...
  if (loadingBuild) {
    return (
      <div className={styles.page}>
        ...
        <div className={styles.inner} style={{ alignItems: 'center', justifyContent: 'center', flex: 1 }}>
    ...
    return (
      <div className={styles.page}>
        ...
        <div className={styles.inner}>
          <p style={{ color: 'var(--error)', fontFamily: "'Exo 2', sans-serif", fontSize: 14 }}>
            Could not load build: {loadError}
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.inner}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <button
            ...
            style={{
              ...
              fontFamily: "'Exo 2', sans-serif", fontSize: 13, cursor: 'pointer',
            }}
          >
            <ArrowLeft size={15} />
            Back to my builds
        ...
        <h1 className={styles.pageTitle}>Edit build</h1>
